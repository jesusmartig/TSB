                    ...
                    <div class="row mb-3">
                        <div class="col-xl-12">
                            <div class="text-xl-end mt-xl-0 mt-1">
                                <a role="button" href="/dashboard/vehiculos/documentos/convenios/crear"
                                   class="btn btn-sm btn btn-info rounded-pill table-hover table-centered">
                                    <i class="fas fa-plus fa-xs"></i> Agregar convenios
                                </a>
                            </div>
                        </div>
                    </div>
        ...
        $(document).ready(function () {
            $('#DataTables').DataTable({
                ...
                columns: [
                    ...
                    {
                        data: "coExpeditiondate",
                        render: function (data, type, row, meta) {
                            return data;
                        },
                    },
                    {
                        data: "coExpirationdate",
                        render: function (data, type, row, meta) {
                            return data;
                        },
                    },
                    {
                        data: "coCollaboratingcompany",
                        render: function (data, type, row, meta) {
                            return data;
                        },
                    },
                    ...
                    },
                    {
                        data: "coId",
                        render: function (data, type, row, meta) {
                            if (row['ocShares'] === null) {
                                return type === "display" ?
                                    `<div class="table-action">

                                <a role="button" href="/dashboard/vehiculos/documentos/convenios/actualizar/${data}"
                                    class="action-icon">
                                ...
                                <a role="button" href="/convenios/pdf/${data}"
                                ...
                                <a role="button" href="/${row['ocShares']}"
                                    class="action-icon" target="_blank">
